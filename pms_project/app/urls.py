...
from app.views import SupplierView, ItemView, ItemCategoryView, PurchaseView, \
    ...
    PrintingView, PrintingStockView ,DispatchView, RpmReadingView

router = DefaultRouter()
router.register('rpm_reading', RpmReadingView, basename="RpmReading")
#router.register('rpm_reading', RpmReadingView)
